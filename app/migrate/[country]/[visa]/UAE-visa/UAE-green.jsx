    ...
    >
      ...
      <ul className="list-disc mb-6 ml-8">
        ...
        <li>
          ...
          AED 2,500 per month on groceries, with dining out ranging from AED 25
          for a casual meal to AED 150 for a fine dining experience.
        </li>
        <li>
          <b>Transportation:</b> Public transportation in the UAE is affordable,
          with metro and bus fares starting from AED 3 per ride. If you prefer
          to drive, fuel prices are relatively low compared to other countries,
          and car rental prices typically range from AED 1,500 to AED 3,000 per
          month for mid-range vehicles.
        </li>
        <li>
          <b>Healthcare:</b> The UAE boasts world-class healthcare facilities,
          but it’s recommended to have health insurance, which can cost anywhere
          between AED 500 to AED 2,000 per month depending on the coverage and
          provider.
        </li>
      </ul>
      <p>
