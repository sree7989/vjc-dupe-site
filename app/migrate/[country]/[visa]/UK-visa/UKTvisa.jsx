...
const Content = () => {
  ...
  <h3 className="text-2xl font-semibold text-black text-center">
    ...
    <span style={{ color: "rgb(220, 4, 4)" }}>VJC Overseas</span>
      ...
      >
        ...
        <div>
          <p style={{ marginBottom: "20px" }}>
            ...
            eligibility criteria to the application process.
          </p>
        </div>
      </div>
      ...
      <p style={{ marginBottom: "20px" }}>
        A UK Tourist Visa is a short-term visa that allows non-UK residents to
      ...
      <p style={{ marginBottom: "20px" }}>
        Citizens of many countries require a UK Tourist Visa to visit the UK.
      ...
      >
        <li>
          <strong>Proof of Intention to Leave the UK:</strong> You must show
          that you have plans to return to your home country before the visa
          expires. This can be demonstrated through ties to your country of
          residence, such as family, employment, or property.
        </li>
        <li>
          <strong>Financial Stability:</strong> You must provide evidence that
          you can financially support yourself during your stay. This may
          include bank statements, pay slips, or sponsorship letters if someone
          is sponsoring your visit.
        </li>
        <li>
          <strong>Travel Itinerary:</strong> You may be asked to provide details
          of your planned activities during your stay in the UK, including
          accommodation bookings and travel plans.
        </li>
        <li>
          <strong>No Intention to Overstay:</strong> The UK government wants to
          ensure that applicants do not plan to overstay their visa. A history
          of compliance with visa regulations will strengthen your application.
        </li>
      </ul>
      ...
      >
        ...
        <li>
          Evidence of financial stability (bank statements, payslips, tax
          returns).
        </li>
        <li>Travel itinerary (flight bookings, hotel reservations).</li>
        <li>
          Proof of ties to your home country (employment letter, property
          ownership).
        </li>
        <li>Health and travel insurance (optional, but recommended).</li>
        <li>
          A sponsorship letter (if someone in the UK is sponsoring your visit).
        </li>
      </ul>
      ...
      >
        <li>
          Complete the online visa application form on the official UK
          government website.
        </li>
        <li>
          Pay the visa application fee online (approximately £100 for up to 6
          months).
        </li>
        <li>
          Schedule an appointment at your nearest UK Visa Application Centre
          (VAC) to submit your biometric information.
        </li>
        <li>Submit all required documents on the day of your appointment.</li>
        <li>
          Wait for processing, which generally takes around 15 business days.
        </li>
        <li>
          Receive your visa in the form of a vignette placed in your passport.
        </li>
      </ol>
      ...
      >
        ...
        <li>
          Inadequate travel history or a pattern of overstaying previous visas.
        </li>
      ...
      >
        <li>
          <strong>Expert Guidance:</strong> Our team provides personalized
          advice and assistance.
        </li>
        <li>
          <strong>Document Review:</strong> Ensure compliance with UK visa
          standards.
        </li>
        <li>
          <strong>Personalized Service:</strong> Tailored advice for unique
          applicant needs.
        </li>
        <li>
          <strong>Efficient Process:</strong> Timely submission and progress
          monitoring.
        </li>
      </ul>
      <p style={{ marginBottom: "20px" }}>
