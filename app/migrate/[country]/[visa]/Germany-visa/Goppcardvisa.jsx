  ...
  return (
    <div className="overflow-x-hidden px-4 sm:px-6 lg:px-8 py-8 bg-white font-times-new-roman text-base">
      ...
      <p className="mb-6 leading-relaxed">
        At{" "}
        <Link href="https://vjcoverseas.com/" className="font-semibold">
          <strong>VJC Overseas</strong>
        </Link>
        , we take immense pride in offering one of the most promising immigration
        solutions to secure your future in Germany — the Germany Opportunity Card.
      ...
      <div className="flex flex-col lg:flex-row items-start lg:space-x-6 space-y-6 lg:space-y-0 mb-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="leading-relaxed">
            ...
            <Link href="https://vjcoverseas.com/migrate-to-germany/" className="font-semibold">
      ...
      <p className="mb-6 leading-relaxed">
        At VJC Overseas, we understand that applying for an international visa can feel overwhelming. Our mission is to simplify the process for skilled professionals and ensure that each stage of the application is completed with precision, clarity, and speed. As one of the leading consultancies in India with offices in Hyderabad and Bangalore, we bring unmatched experience in guiding applicants through the Germany Opportunity Card process. If you're looking for trusted professionals, we are among the{" "}
        <Link href="https://vjcoverseas.com/" className="font-semibold">
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        ...
        <li>
          <strong>Job Flexibility Without an Offer Letter:</strong> One major advantage of the Germany Opportunity Card is that it allows you to enter Germany without a job offer and search for relevant employment while you're there.
        </li>
        <li>
      ...
      <p className="mb-6 leading-relaxed">
        ...
        <Link href="https://vjcoverseas.com/assessment" className="font-semibold">
          <strong>eligibility for the Germany Opportunity Card</strong>
        </Link>
        .
      </p>
      ...
      <p className="mb-6 italic text-sm leading-relaxed">
        “I never thought that applying for the{" "}
        <Link href="https://vjcoverseas.com/germany-opportunity-card" className="font-semibold">
          <strong>Germany Opportunity Card</strong>
        </Link>{" "}
        would be this easy. Thanks to VJC Overseas, my visa was approved quickly, and I found a great job within just a few months.” — Anjali S., Software Developer
      </p>
      ...
      <div className="mt-6 mb-4">
        ...
        <p className="mt-2 leading-relaxed">
          The Germany Opportunity Card offers the ideal opportunity for you to live, work, and settle in Germany, backed by a streamlined process and professional guidance. Check your eligibility for the Germany Opportunity Card today to take the first step. Whether you're looking for migration, career advancement, or long-term residency, VJC Overseas is here to make your dream a reality.
        </p>
        <p className="mt-2 leading-relaxed font-bold text-black">
          Book a Free Consultation today and let our experts guide you through every step of your Germany Opportunity Card journey.
        </p>
      </div>
    </div>
  );
