  ...
  return (
    ...
    >
      ...
      <p className="mb-6">
        ...
        balance, high salaries, and strong labour rights, making it an
        attractive destination for skilled professionals. Whether you are
      ...
      <h4 className="mb-6 text-lg font-bold text-bold">
        Types of Denmark Work Permits
      </h4>
      <p className="mb-6">
        Denmark offers several types of work permits based on your
        qualifications and the type of job you’re seeking. The most common types
        include:
      </p>
      <ol className="list-disc ml-8 mb-6">
        <li>
          <b>The Positive List Scheme</b>
          <p>
            For professionals in fields where Denmark faces a shortage of
            qualified workers (such as IT, engineering, healthcare, etc.).
          </p>
        </li>
        <li>
          <b>The Pay Limit Scheme</b>
          <p>
            For highly-paid individuals with a salary above a certain threshold
            (currently DKK 450,000 annually, as of 2024).
          </p>
        </li>
        <li>
          <b>The Start-up Denmark Scheme</b>
          <p>For entrepreneurs who wish to start a business in Denmark.</p>
        </li>
        <li>
          <b>The Labour Market Scheme</b>
          <p>
            For general employment in sectors with a demand for foreign labour.
          </p>
        </li>
      </ol>
      <p className="mb-6">
      ...
      <ul className="mb-6 ml-8 list-disc">
        ...
        <li>
          Proof of qualifications, experience, and professional skills that
          match the job.
        </li>
        <li>You must not have a criminal record.</li>
        <li>A clean health check (if required by the visa type).</li>
        <li>
          A minimum annual salary based on the visa category (especially for
          schemes like the Pay Limit Scheme).
        </li>
      </ul>
      <hr style={{ borderColor: "black" }} className="mb-6" />
      ...
      <ul className="mb-6 ml-8 list-disc">
        <li>
          <b>Standard Processing Time: </b>1 to 3 months.
        </li>
        <li>
          <b>Pay Limit Scheme and Positive List Visa: </b>2 to 4 weeks
        </li>
        <li>
          <b>Start-up Visa: </b>Approximately 6 to 8 weeks.
        </li>
      </ul>
      <p className="mb-6">
      ...
      <ul className="mb-6 ml-8 list-disc">
        <li>
          <b>Work Permit Visa Fee: </b>DKK 3,500 to DKK 5,000 (approximately USD
          500 to USD 700).
        </li>
        <li>
          <b>Start-up Visa Fee: </b>DKK 6,000 (approximately USD 850).
        </li>
        <li>
          <b>Extension Fees: </b>If you're applying for an extension of your
          work permit, the fee is generally around DKK 1,500 to DKK 2,000.
        </li>
      </ul>
      <p className="mb-6">
        These fees are subject to change based on your nationality, the type of
      ...
      <p className="mb-6">
        At <b>VJC Overseas</b>, we understand the complexities of international
        visa applications, and we are here to help you every step of the way.
        From determining your eligibility to assisting with your application and
        supporting you during the visa approval process, we offer a seamless
        experience.
      </p>
      <ul className="mb-6 ml-8 list-disc">
        <li>
          <b>Expert Guidance: </b>Our team has years of experience with
          Denmark’s work visa procedures, ensuring your application meets all
          requirements.
        </li>
        <li>
          <b>Comprehensive Services: </b>From job search assistance to visa
          processing, we provide end-to-end support to help you achieve your
          career goals in Denmark.
        </li>
        <li>
          <b>Personalized Assistance: </b>We offer tailored solutions based on
          your qualifications, experience, and career goals, ensuring the right
          work permit pathway for you.
        </li>
      </ul>
      <p className="mb-6">
      ...
      <hr style={{ borderColor: "black" }} className="mb-6" />
      <h4 className="mb-6 font-bold text-lg text-bold">
        Get in Touch with VJC Overseas
      </h4>
      <p className="mb-6">
