...
const GermanyWorkVisa = () => {
  ...
  <h2 className="text-1xl font-semibold mb-2">Start Your Germany Work Visa Journey with <span className="text-orange-500 font-bold">VJC Overseas</span> Today!</h2>
  <p>
