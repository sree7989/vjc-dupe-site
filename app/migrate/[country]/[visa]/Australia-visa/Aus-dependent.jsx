...
const Ausdependent = () => {
  return (
    ...
    >
      ...
      <h4 className="mb-6">
        <b>What is the Australia Dependent Visa?</b>
      </h4>
      ...
      <h4 className="mb-6">
        <b>Key Features of the Dependent Visa</b>
      </h4>
      ...
      <ul className="ml-6 mb-6">
        ...
        <li>
          ...
          eligible for Australia’s public health system (Medicare), depending on
          the visa subclass and the primary visa holder’s status.
        </li>
        <li>
          <b>• Study Opportunities: </b>Family members, particularly children,
          can also access Australia’s quality education system, from primary
          school to university-level courses.
        </li>
      </ul>
      ...
      <p className="mb-6">
        Depending on the primary visa holder’s status, there are different types
        of dependent visas available. These include:
      </p>
      ...
      <p className="mb-6">
        To qualify for an Australian Dependent Visa, the applicant must meet
        certain criteria:
      </p>

      <ul className="ml-6 mb-6">
        <li>
          <b>• Relationship to the Primary Visa Holder:</b> The applicant must
          be a legitimate family member of the primary visa holder, such as a
          spouse, de facto partner, or dependent child under 18 years old.
        </li>
        <li>
        ...
        <li>
          ...
          the health and character standards set by the Australian government,
          including undergoing medical examinations and police checks.
        </li>
        <li>
          <b>• Proof of Relationship: </b>Applicants must provide sufficient
          evidence of their relationship with the primary visa holder. This
          could include marriage certificates, birth certificates, or evidence
          of cohabitation for de facto partners.
        </li>
      </ul>
      ...
      <p className="mb-6">
        Applying for an Australian Dependent Visa involves several steps:
      </p>

      <ol className="ml-6 mb-6">
        <li>
          <b>1. Gather Documents: </b>Collect all required documents, including
          proof of relationship, health examinations, police certificates, and
          financial evidence.
        </li>
        <li>
          <b>2. Submit Application: </b>Submit your visa application online via
          the Australian Department of Home Affairs website or through a
          registered migration agent.
        </li>
        <li>
          <b>3. Wait for Decision: </b>The processing time varies depending on
          the visa subclass, but it generally takes several months to receive a
          decision.
        </li>
        <li>
      ...
      <ul className="ml-6">
        <li>
          <b>• Personalized Consultation: </b>We offer one-on-one consultations
          to assess your specific situation and provide tailored advice.
        </li>
        <li>
          <b>• Comprehensive Visa Services: </b>From gathering documents to
          submitting your application, we handle every detail, reducing the
          chances of delays or errors.
        </li>
        <li>
          <b>• Expert Guidance: </b>With years of experience and up-to-date
          knowledge of immigration laws, we ensure your application complies
          with all the requirements.
        </li>
        <li>
          <b>• Ongoing Support: </b>Our support doesn’t end once you submit your
          application. We are here to assist you throughout the processing
          period and provide updates on your visa status.
        </li>
      </ul>
      ...
      <p className="mb-6">
        The <b>Australia Dependent Visa</b> is a wonderful opportunity for
        families to reunite and live together in one of the most desirable
        countries in the world. Whether you’re planning to join a spouse,
        support a child, or be with a parent, this visa can make it all
        possible.
      </p>
      ...
      <h4 className="mb-6">
        <b>
          Take the first step towards a new chapter in Australia. Your family’s
          future starts here!
        </b>
      </h4>
    </div>
