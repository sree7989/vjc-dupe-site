    ...
    >
      <div style={{ marginBottom: "5%" }}>
        <h3 className="text-2xl mt-4 font-semibold text-black text-center">
          New Zealand Tourist Visa - VJC Overseas
      ...
      <p className="mb-6">
        New Zealand, with its breath taking landscapes, vibrant culture, and
      ...
      <p className="mb-6">
        We can help you determine the right visa for your trip, ensuring that
      ...
      <ul className="list-disc mb-6 ml-8">
        <li>
          ...
          months beyond your intended departure date from New Zealand.
        </li>
        <li>
          <b>Proof of Funds: </b>Evidence that you have sufficient funds to
          support yourself during your stay in New Zealand.
        </li>
        <li>
          <b>Travel Itinerary:</b>A detailed travel itinerary, including
          accommodation details, flight bookings, and planned activities.
        </li>
        <li>
          <b>Heaith and Character Requirements: </b>Depending on the length of
          your stay, you may need to provide a medical certificate or police
          clearance.
        </li>
        <li>
          <b>Visa Fee:</b>The visa fee must be paid at the time of your
          application. Fees vary depending on the type of visa and duration of
          stay.
        </li>
      </ul>
      <h3 className=" m-2 font-bold text-black text-lg mb-6">
      ...
      <ul className="list-disc mb-6 ml-8">
        <li>
          <b>Visitor Visa: </b>NZD 165 to NZD 250 (depending on the duration of
          stay)
        </li>
        <li>
          <b>Multiple Entry Visa: </b>NZD 300 to NZD 450
        </li>
        <li>
          <b>Transit Visa: </b>NZD 50 to NZD 100
        </li>
      </ul>
      ...
      <p className="mb-6">
        Processing times for New Zealand Tourist Visas can vary based on the
        type of visa and the volume of applications being processed at the time.
        On average, processing times are as follows:
      </p>
      <ul className="list-decimal mb-6 ml-8">
        <li>
          <b>Visitor Visa: </b>20 to 30 business days
        </li>
        <li>
          <b>Multiple Entry Visa: </b>30 to 45 business days
        </li>
        <li>
          <b>Transit Visa: </b>10 to 15 business days
        </li>
      </ul>
      <p className="mb-6">
        Please note that applications submitted during peak travel seasons may
        experience longer processing times. To avoid any travel disruptions, we
        recommend applying at least 6 to 8 weeks before your planned departure.
      </p>
