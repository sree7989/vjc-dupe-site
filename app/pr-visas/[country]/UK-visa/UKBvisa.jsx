...
const UKPR = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 -mt-10 font-[Times_New_Roman]">
      ...
      <p>
        For accurate assessment, <span className="text-orange-600 font-semibold"><a href="https://vjcoverseas.com/pr-visas/uk-pr">UK Immigration Consultants</a></span> like <strong>VJC Overseas</strong> analyze your profile, visa history, and eligibility before recommending the right pathway.
      </p>
      ...
      <p>
        If you're ready to begin your journey to <strong>UK Permanent Residency</strong>, connect with <span className="text-orange-600 font-semibold"><a href="https://vjcoverseas.com">VJC Overseas</a></span> today. Let our expert team help you make your dream of settling in the UK a reality.
      </p>
   </div>
  );
};
