    ...
    <div className="px-4 sm:px-4 py-10 max-w-6xl mx-auto text-justify text-base sm:text-[1.rem] leading-6 text-gray-800">
      ...
      <div className="space-y-6">
        <section>
          ...
          <p>
            The Federal Skilled Worker Program <span className="text-orange-500"><a href="https://vjcoverseas.com/pr-visas/canada-pr/canada-fswp">FSWP Canada PR </a></span>
        ...
        <section>
          <h2 className="text-xl sm:text-1xl font-bold text-black mb-2">How <span className="text-orange-500"><a href="https://vjcoverseas.com/pr-visas">PR Visa Consultants</a></span> from <span className="font-bold text-black">VJC Overseas</span> Support Your Application</h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            The <span className="text-orange-500"><a href="https://vjcoverseas.com/pr-visas/canada-pr">Canada PR Visa</a></span> is your gateway to permanent residence, 
            and with <span className="text-orange-500"><a href="https://vjcoverseas.com">Best Visa Immigration Consultants</a></span> like <span className="font-bold text-black">VJC Overseas</span>, 
