      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            <a href="https://vjcoverseas.com/pr-visas/canada-pr" className="text-orange-500 font-semibold">Canada PR Visa</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            With <a href="https://vjcoverseas.com/pr-visas" className="text-orange-500 font-semibold">PR Visa Consultants</a> from VJC Overseas, your FSTP application is in expert hands:
          </p>
          <ul className="list-disc list-inside ml-4 mt-2">
        ...
        <section>
          ...
          <p>
            ...
            <a href="https://vjcoverseas.com" className="text-orange-500 font-semibold">Best Visa Immigration Consultants</a> ensures your journey is smooth and reliable.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <a href="https://vjcoverseas.com" className="text-orange-500 font-semibold">VJC Overseas</a> guide you every step of the way with professional support, practical advice, and a tailored strategy for your future.
          </p>
